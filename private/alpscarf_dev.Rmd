...
# generate Alpscarf dataset; calculate the confomity/revisiting scores and translate them into bar height
...
for(a_p_name in unique(lsa_reduced_dwell_alp_df$p_name)){
  ...
  df_p_temp <- alpscarf_width_trans(df_p)
  ...
  lsa_scarf_vis[[a_p_nr]] <- alpscarf_plot_gen(df_p_temp, my_palette, TRANSITION_FOCUS = TRUE, ALPSCARF_EN = TRUE,  max_y_value = plot_height)
}
